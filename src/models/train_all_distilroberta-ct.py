...
def main():
    '''
    Trains CT with in-batch negatives model backed by fine-tuned DistilRoBERTa and saves to ../models
    Using in-batch negatives slightly improves performance of CT
    '''
    logger = logging.getLogger(__name__)
    logger.info('training all_DistilRoBERTa-CT with in-batch negatives model from training data ../data/processed/train.pkl')
    ...
    # save fitted model
    save_path = str(project_dir.joinpath(f'models/all_distilroberta-ct'))
