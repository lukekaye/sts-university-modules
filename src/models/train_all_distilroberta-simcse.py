...
def main():
    '''
    Trains SimCSE model backed by fine-tuned DistilRoBERTa and saves to ../models
    '''
    logger = logging.getLogger(__name__)
    logger.info('training all_DistilRoBERTa-SimCSE model from training data ../data/processed/train.pkl')
    ...
    # save fitted model
    save_path = str(project_dir.joinpath(f'models/all_distilroberta-simcse'))
