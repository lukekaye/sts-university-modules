...
def main():
    '''
    Trains TSDAE backed by fine-tuned DistilRoBERTa model and saves to ../models
    '''
    logger = logging.getLogger(__name__)
    logger.info('training all_DistilRoBERTa-TSDAE model from training data ../data/processed/train.pkl')
    ...
    # further fine-tune fine-tuned DistilRoBERTa model using TSDAE approach
    model.fit(
    ...
    # save model
    save_path = str(project_dir.joinpath(f'models/all_distilroberta-tsdae'))
