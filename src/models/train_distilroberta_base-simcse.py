...
def main():
    '''
    Trains SimCSE model backed by DistilRoBERTa and saves to ../models
    '''
    logger = logging.getLogger(__name__)
    logger.info('training DistilRoBERTa-SimCSE model from training data ../data/processed/train.pkl')
    ...
    # save fitted model
    save_path = str(project_dir.joinpath(f'models/distilroberta-simcse'))
