...
def main():
    '''
    Trains DistilRoBERTa-TSDAE model and saves to ../models
    '''
    logger = logging.getLogger(__name__)
    logger.info('training DistilRoBERTa-TSDAE model from training data ../data/processed/train.pkl')
    ...
    # fine-tune pre-trained DistilRoBERTa model using TSDAE approach
    model.fit(
    ...
    # save model
    save_path = str(project_dir.joinpath(f'models/distilroberta-tsdae'))
